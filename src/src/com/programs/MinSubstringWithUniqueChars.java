...
public class MinSubstringWithUniqueChars {
    ...
    // DP question
    // with look up data structure is min heap
    // Iterate through given string
    // At every new character, find the substring that includes this character (if possible)
    // if yes record it's length and start and end if it's min length so far.
    // go on
